            ...
            <div style="margin-top: 9rem;" class="col-md-6">
                ...
                <div class="card card-primary border-primary">
                    <div class="card-header bg-primary">
                        <h3 class="text-light card-title mb-0">ADD NEW ALUSISTA</h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form action="backend/proses_add_alusista.php" method="post" enctype="multipart/form-data">
                        <div class="card-body">
                            <div class="form-group">
                                <label>Nama alusista</label>
                                <input type="text" class="form-control" name="nama_alusista">
                            </div>
                            <div class="form-group">
