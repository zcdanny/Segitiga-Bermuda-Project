...
$alusistadbs = mysqli_query($connection, "SELECT * FROM alusista JOIN kategori ON alusista.id_kategori = kategori.id_kategori WHERE alusista.id_kategori = 4");
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item active"><a class="nav-link" href="alusista.php">alusista alusista</a></li>
