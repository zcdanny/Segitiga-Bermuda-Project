...
<body>
    ...
    <div class="products">
        <div class="container">
            <a class="btn btn-primary mb-4" href="add_alusista.php">New Data</a>
                ...
                ?>
                    <div class="col-md-4">
                        <div class="product-item">
                            <img src="assets/images/alusista/<?php echo $alusistadb['foto_1']; ?>" alt="">
                            <div class="down-content">
                                ...
                                <div class="product-action d-flex justify-content-around">
                                    <a class="btn btn-warning" href="edit_alusista.php?id=<?php echo $alusistadb["id_alusista"] ?>">EDIT</a>
                                    <a class="btn btn-danger" href="backend/proses_delete_alusista.php?id=<?php echo $alusistadb["id_alusista"] ?>" onclick="return confirm('Are you sure you want to delete this item?');">DELETE</a>
                                </div>
                            </div>
                        </div>
                    </div>
