  ...
  <div class="best-features">
    <div class="container">
      ...
      <div class="col-12 col-md-6 col-lg-3 mb-5 mb-md-0">
        <img src="assets/images/user/danny.jpg" class="img-fluid mb-5">
      ...
      <!-- Start Column 2 -->
      <div class="col-12 col-md-6 col-lg-3 mb-5 mb-md-0">
        <img src="assets/images/user/indra.jpg" class="img-fluid mb-5">
      ...
      <!-- Start Column 3 -->
      <div class="col-12 col-md-6 col-lg-3 mb-5 mb-md-0">
        <img src="assets/images/user/febrian.jpg" class="img-fluid mb-5">
      ...
      <!-- Start Column 4 -->
      <div class="col-12 col-md-6 col-lg-3 mb-5 mb-md-0">
        <img src="assets/images/user/irsyad.jpg" class="img-fluid mb-5">

        <h3 clas><a href="#"><span class="">Irsyad</span> Zainal</a></h3>
